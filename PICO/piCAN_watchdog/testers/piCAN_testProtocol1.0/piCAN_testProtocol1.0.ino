...
void setupSensors(){
  ...
  getit.setInterval(20, definer); //-------------------ciclo para levantar datos fisicos
}
...
void definer(){
  if ((millis() - 2000) <= GOtime){
    phy_torq = 0;
  }
  else if ((millis() - 10000) <= GOtime){
    phy_torq = 10;
  }
  else phy_torq = 0;
